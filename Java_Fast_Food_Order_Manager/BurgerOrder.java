...
public class BurgerOrder {
    ...
    public String toString() {
        return "Burger Order Number: " + orderNum + ", Hamburgers: " + numHamburgers + ", Cheeseburgers: " + numCheeseburgers
                + ", Veggieburgers: " + numVeggieburgers + ", Sodas: " + numSodas + ", ToGo: " + orderToGo;
    }
