 ...
 */
import java.util.*;
public class Dvds extends FullInventorySort {
    /**
     * Dvds class inherits the attributes and methods from the the class FullInventorySort, this way it does not need an ArrayList
     * Resource: https://www.w3schools.com/java/java_inheritance.asp
     *@param int price, books price
     *@param int inventory, amount of dvds in inventory
     */
    public Dvds(int price, int inventory) {
        super(price, inventory);    //sets the Dvds price and inventory size to the parent class in FullInventorySort
